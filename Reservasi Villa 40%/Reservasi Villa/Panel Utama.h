...
#define  PANEL_1                          1       /* callback function: panel_login */
#define  PANEL_1_STRING_2                 2       /* control type: string, callback function: (none) */
#define  PANEL_1_STRING                   3       /* control type: string, callback function: (none) */
#define  PANEL_1_TombolCancel             4       /* control type: command, callback function: cancel */
#define  PANEL_1_TombolLogin              5       /* control type: command, callback function: login */
#define  PANEL_1_TEXTMSG_2                6       /* control type: textMsg, callback function: (none) */
#define  PANEL_1_PICTURE_2                7       /* control type: picture, callback function: picture_login */
#define  PANEL_1_PICTURE                  8       /* control type: picture, callback function: picture_login */
#define  PANEL_1_PICTURE_3                9       /* control type: picture, callback function: picture_login */
#define  PANEL_1_PICTURE_4                10      /* control type: picture, callback function: picture_login */
#define  PANEL_1_TEXTMSG                  11      /* control type: textMsg, callback function: (none) */
