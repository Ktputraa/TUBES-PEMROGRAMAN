...
#define  PANEL_2_COMMANDBUTTON_3          3       /* control type: command, callback function: Tombol_TR */
...
int  CVICALLBACK Tombol_TR(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
