...
#define  PANEL_4_STRING_3                 15      /* control type: string, callback function: (none) */
...
#define  PANEL_4_DECORATION               24      /* control type: deco, callback function: (none) */
#define  PANEL_4_TEXTMSG                  25      /* control type: textMsg, callback function: (none) */
